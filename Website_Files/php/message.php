...
<div data-role="page">
    <div class="ui-body-b ui-body">
        <div data-role="navbar">
            <ul>
                <li><a href="../prostate-cancer.php#home" rel="external">Home</a></li>
                <li><a href="../prostate-cancer.php#dashboard" rel="external">Dashboard</a></li>
                <li><a href="../prostate-cancer.php#about" rel="external">About</a></li>
            </ul>
        </div>
    </div>
